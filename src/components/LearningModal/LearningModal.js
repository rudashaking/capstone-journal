  ...
  return (
    ...
    >
      <div className="learning-modal">
        {img && (
          <img src={img} alt="Learning Modal Image" className="modal-image" />
        )}
...
const LearningModals = () => {
  ...
  const [modals] = useState([
    ...
    },
    {
      ...
      content:
        "Activate the Mood Analyzer feature, speak into it, and Jackie will respond with a quote, song suggestion, and health tip based on your mood.",
      img: mood,
    },
    {
      title: "Access Your Journal",
      content:
        "Click on the bookmark to open your journal and start documenting your thoughts and experiences.",
      img: bookmark,
    },
    {
      title: "Disclaimer",
      content:
        "Please note that the use of this app is not a replacement for conventional mental health services. Seek professional help if needed.",
      img: jackie,
    },
    {
      title: "Local Supports",
      content:
        "Explore the Profile section for a collection of local mental health support services.",
      img: jackie,
    },
  ]);
